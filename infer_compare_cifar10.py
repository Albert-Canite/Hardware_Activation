...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="./checkpoints/cifar10_vgg11_quantrelu8.pth")
    parser.add_argument("--lut-xlsx", type=str, default="./LUT_ReLU.xlsx")
    parser.add_argument("--interp-lut-csv", type=str, default="./checkpoints/lut_relu_8bit_cifar10.csv")
